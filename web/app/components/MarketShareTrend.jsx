      ...
      {mirror_gaps && Object.keys(mirror_gaps).length > 0 && (
        <p className="text-[11px] text-slate-400 mt-3 leading-6">
          ⚠️ {Object.entries(mirror_gaps)
            ...
            .join(" — ")}{" "}
          (یعنی برای این سال‌ها هیچ عدد قابل‌اتکایی نداریم — نه اینکه صادراتشان صفر شده — برای
          مقصدهایی که در بخش‌های دیگر همین سایت پوشش دارند، آمار وارداتی مقصد را ببینید، نه این جدول.)
        </p>
      )}
    </section>
  );
