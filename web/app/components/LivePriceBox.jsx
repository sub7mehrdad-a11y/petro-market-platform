  ...
  return (
    <div className="border border-emerald-200 bg-emerald-50 rounded-lg p-4 mb-4">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h4 className="text-sm font-semibold text-emerald-900">قیمت‌های زنده‌ی این کشور (آخرین به‌روزرسانی خودکار)</h4>
      </div>
      <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
        {prices.map((p, i) => (
          <div key={i} className="text-sm bg-white rounded-md px-3 py-2 border border-emerald-100">
