...
# صادرات روسیه — کاربر داده‌ی چندساله (۲۰۲۱ تا ۲۰۲۶) داد، ولی فقط ۲۰۲۱ عدد
# دلاریِ دقیق و رسمی داره («آمار رسمی نهایی گمرک، FTS/UN Comtrade» طبق خودِ
# کاربر) — سال‌های ۲۰۲۲ تا ۲۰۲۵ فقط بازه‌ی تناژِ برآوردی دارن (بدون رقم دلاری
# دقیق) و ۲۰۲۶ صراحتاً هدف‌گذاریه، نه واقعی. چون این نمودار بر مبنای سهم
# دلاریِ قابل‌مقایسه با سبد WITS کار می‌کنه، فقط سالی که عدد دلاریِ دقیق و
# مستند داره اینجا میاد؛ روند کامل ۲۰۲۱-۲۰۲۶ (با برچسب کیفیت داده‌ی هر سال) در
# پروفایل رقیب روسیه (data/competitors.json → export_volume_trend) ثبت شده،
# نه اینجا — چون اون بخش برای داده‌ی بازه‌ای/برآوردی/هدف طراحی شده، این نمودار نه.
RUSSIA_CUSTOMS_EXPORTS = {
    2021: {"value_usd_k": 34900, "quantity_kg": 157266000},
}
        ...
        "manual_overrides": {
            fa: {
                ...
                "source": {
                    ...
                    "روسیه": "آمار رسمی نهایی گمرک روسیه (FTS / UN Comtrade)، ارائه‌شده توسط کاربر",
