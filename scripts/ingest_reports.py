...
REPORTS = [
    ...
    {
        "file": "گزارش_خلاصه_بازار_جوش_شیرین_روسیه.docx",
        "country": "روسیه",
        "type": "summary",
    },
    {
    ...
    {
        "file": "گزارش_خلاصه_بازار_جوش_شیرین_ازبکستان.docx",
        "country": "ازبکستان",
        "type": "summary",
    },
    {
    ...
    {
        # گزارش مصرف سرانه‌ی جهانی — منبع جدول مصرف سرانه‌ای که در
    ...
    {
        # رژیم تجاری CIS (مشترک‌المنافع کشورهای مستقل) و جایگاه جوش شیرین در
        # اون — به خودِ اتحادیه‌ی CIS مربوطه، نه یک کشور خاص؛ country="سی‌آی‌اس"
        # مثل "اوراسیا" یک برچسب غیر-کشوریه (نگاه کن NON_COUNTRY_LABELS و
        # UNION_REPORT_LABELS توی web/lib/data.js) و توی صفحه‌ی /unions/cis
        # نمایش داده می‌شه، نه توی /countries. کاربر خودش نویسنده‌ی HTML بود
        # (مثل گزارش قزاقستان)، فقط جای‌گذاری و اتصال به پایپ‌لاین لازم بود.
        "file": "گزارش_رژیم_تجاری_CIS_و_جوش_شیرین.html",
        "country": "سی‌آی‌اس",
        "type": "detailed",
    },
    {
        # بازنویسی‌شده به HTML طراحی‌شده — نسخه‌ی Word قبلی جایگزین شد.
        "file": "گزارش_تحلیلی_بازار_جوش_شیرین_تاجیکستان.html",
        "country": "تاجیکستان",
        "type": "detailed",
    },
    {
        "file": "گزارش_خلاصه_بازار_جوش_شیرین_تاجیکستان.docx",
        "country": "تاجیکستان",
        "type": "summary",
    },
]
